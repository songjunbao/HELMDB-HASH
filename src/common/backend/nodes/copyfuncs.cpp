...
static void CopyScanFields(const Scan* from, Scan* newnode)
{
    ...
    /* For Multi-model Query */
    COPY_SCALAR_FIELD(mm_type);
}
...
/*
 * Description: Copy CypherMatchExpr node
 *
 * Parameters:
 *	@in from: source CypherMatchExpr node
 *
 * Return: CypherMatchExpr*
 */
static CypherMatchExpr* _copyCypherMatchExpr(const CypherMatchExpr* from)
{
    CypherMatchExpr* newnode = makeNode(CypherMatchExpr);

    COPY_NODE_FIELD(match_node_list);
    COPY_NODE_FIELD(match_rel_list);

    return newnode;
}
/*
 * Description: Copy CypherMatchRestrictExpr node
 *
 * Parameters:
 *	@in from: source CypherMatchRestrictExpr node
 *
 * Return: CypherMatchRestrictExpr*
 */
static CypherMatchRestrictExpr* _copyCypherMatchRestrictExpr(const CypherMatchRestrictExpr* from)
{
    CypherMatchRestrictExpr* newnode = makeNode(CypherMatchRestrictExpr);
...
/*
 * Description: Copy CypherStmt node
 *
 * Parameters:
 *	@in from: source CypherStmt node
 *
 * Return: CypherStmt*
 */
static CypherStmt* _copyCypherStmt(const CypherStmt* from)
{
    CypherStmt* newnode = makeNode(CypherStmt);

    COPY_NODE_FIELD(match_pattern);
...
/*
 * Description: Copy RangeCypher node
 *
 * Parameters:
 *	@in from: source RangeCypher node
 *
 * Return: RangeCypher*
 */
static RangeCypher* _copyRangeCypher(const RangeCypher* from)
{
    RangeCypher* newnode = makeNode(RangeCypher);

    COPY_NODE_FIELD(relation);
    COPY_NODE_FIELD(cypher_query);
    COPY_NODE_FIELD(alias);
...
static Query* _copyQuery(const Query* from)
{
    ...
    /* For Graph Query */
    COPY_NODE_FIELD(cypher_match);
    COPY_SCALAR_FIELD(is_cypher_query);
    // For Array Query
    COPY_SCALAR_FIELD(is_array_select);
    COPY_NODE_FIELD(arraySelectClause);
    ...
    switch (nodeTag(from)) {
       ...
       case T_AlterEventTrigStmt:
        ...
        case T_RangeTimeCapsule:
            ...
            break;
        case T_RangeCypher:
            retval = _copyRangeCypher((RangeCypher*)from);
            break;
        case T_TypeName:
        ...
        case T_TimeCapsuleClause:
            ...
            break;
        case T_CypherMatchExpr:
            retval = _copyCypherMatchExpr((CypherMatchExpr*)from);
            break;
        case T_CypherMatchRestrictExpr:
            retval = _copyCypherMatchRestrictExpr((CypherMatchRestrictExpr*)from);
            break;
        case T_CypherStmt:
            retval = _copyCypherStmt((CypherStmt*)from);
            break;
        case T_CypherNode:
            retval = _copyCypherNode((CypherNode*)from);
            break;
        case T_CypherName:
            retval = _copyCypherName((CypherName*)from);
            break;
        case T_CypherRel:
            retval = _copyCypherRel((CypherRel*)from);
            break;
        case T_CypherPath:
            retval = _copyCypherPath((CypherPath*)from);
            break;
