    ...
    ParamListInfo params)
{
    ...
    switch (ftype) {
        ...
        case NONE_FUSION:
            opfusionObj = NULL;
            break;
        case NVM_SELECT_FUSION:
            opfusionObj = New(objCxt)NvmSelectFusion(context, psrc, plantree_list, params);
            break;
        case NVM_UPDATE_FUSION:
            opfusionObj = New(objCxt)NvmUpdateFusion(context, psrc, plantree_list, params);
            break;
        case NVM_INSERT_FUSION:
            opfusionObj = New(objCxt)NvmInsertFusion(context, psrc, plantree_list, params);
            break;
        case NVM_DELETE_FUSION:
            opfusionObj = New(objCxt)NvmDeleteFusion(context, psrc, plantree_list, params);
            break;
        default:
            opfusionObj = NULL;
            break;
